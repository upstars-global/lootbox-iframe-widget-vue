...
export function useWheelAnimation(
   ...
   *
   * Підготовка анімації:
   * 1. Генерація випадкового кута для різноманітності
   * 2. Розрахунок фінального кута для цільового сектора
   * 3. Визначення тривалості анімації залежно від наявності виграшного сектора
   * 4. Запуск покадрової анімації
   */
  const spinTo = () => {
